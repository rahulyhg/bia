...
.controller('HomeCtrl', function($scope, $location, $window, MyServices, $ionicLoading, $timeout, $sce, $ionicSlideBoxDelegate, $ionicModal) {
  addanalytics("Home page");

  $ionicModal.fromTemplateUrl('templates/appView/modal-ads.html', {
    scope: $scope,
...
.controller('MembersCtrl', function($scope, MyServices, $ionicLoading, $filter, $location) {
  ...
  MyServices.getallmembers(function(data) {
    $scope.members = data;
    // $ionicSlideBoxDelegate.update();
  }, function(err) {
    $location.url("/access/offline");
